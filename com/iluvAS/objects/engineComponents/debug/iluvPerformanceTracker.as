package iluvAS.objects.engineComponents.debug 
{
	 ...
	 * @author ...
	 */
	public class iluvPerformanceTracker extends Sprite 
	{
		...
		public function iluvPerformanceTracker() 
		{
			
			mem_max = 0;
			
			xml = <xml><ver>VER:</ver><fps>FPS:</fps><ms>MS:</ms><mem>MEM:</mem><memMax>MAX:</memMax></xml>;
			
			style = new StyleSheet();
			style.setStyle('xml', { fontSize:'9px', fontFamily:'_sans', leading:'-2px' } );
			style.setStyle('ver', { color: hex2css(colors.ver) } );
			...
			xml.ver = "VER : " + iluvGameProperties.VERSION + iluvEngine.swfSite;
